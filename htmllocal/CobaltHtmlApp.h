...
class CobaltHtmlApp: public PluginHost::IPlugin,
              public PluginHost::IWeb,
              public PluginHost::JSONRPC {
private:
  CobaltHtmlApp(const CobaltHtmlApp&);
  CobaltHtmlApp& operator=(const CobaltHtmlApp&);
  ...
  public:
    explicit Notification(CobaltHtmlApp *parent) :
      _parent(*parent) {
...
public:
  ...
  virtual ~CobaltHtmlApp() {
    TRACE_L1("Destructor CobaltHtmlApp.%d", __LINE__);
    UnregisterAll();
  }

public:
  BEGIN_INTERFACE_MAP (CobaltHtmlApp)
