...
# limitations under the License.
{
  'variables': {
    ...
    'audio_sink_sources': [
        ...
        '<(DEPTH)/third_party/starboard/rdk/shared/audio_sink/gstreamer_audio_sink_type.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/audio_sink/audio_sink_is_audio_sample_type_supported.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/audio_sink/gstreamer_audio_sink_type_lifecycle.cc',
    ],
    ...
    'media_sources': [
        ...
        '<(DEPTH)/third_party/starboard/rdk/shared/media/gst_media_utils.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_audio_buffer_budget.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_buffer_alignment.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_buffer_allocation_unit.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_buffer_garbage_collection_duration_threshold.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_buffer_padding.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_buffer_storage_type.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_initial_buffer_capacity.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_max_buffer_capacity.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_progressive_buffer_budget.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_get_video_buffer_budget.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_is_audio_supported.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_is_buffer_pool_allocate_on_demand.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_is_buffer_using_memory_pool.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/media/media_is_output_protected.cc',
    ...
    'player_sources': [
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_create.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_destroy.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_get_current_frame.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_get_info.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_get_maximum_number_of_samples_per_write.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_internal.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_output_mode_supported.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_seek.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_set_bounds.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/player/player_set_playback_rate.cc',
    ...
    'system_sources': [
        ...
        '<(DEPTH)/third_party/starboard/rdk/shared/system/extension_graphics.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/system/system_get_extensions.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/system/system_sign_with_certification_secret_key.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/system/accessibility_get_caption_settings.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/system/accessibility_set_captions_enabled.cc',
				'<(DEPTH)/third_party/starboard/rdk/shared/system/system_get_total_cpu_memory.cc',
				'<(DEPTH)/third_party/starboard/rdk/shared/system/system_get_total_gpu_memory.cc',
    ...
    'window_sources': [
        ...
        '<(DEPTH)/third_party/starboard/rdk/shared/window/window_create.cc',
        '<(DEPTH)/third_party/starboard/rdk/shared/window/window_destroy.cc',
    ...
    'sources': [
        ...
        '<(DEPTH)/third_party/starboard/rdk/shared/system/cpu_features_get.cc',
        ...
        '<(DEPTH)/third_party/starboard/rdk/shared/signal/system_request_freeze.cc',
        ...
        # Cobalt 2022 Speech Recognizer is deprecated, switch to microphone implementation.
    ...
    'conditions': [
      ['<(has_ocdm)==1', {
        ...
        'dependencies': [
          '<(DEPTH)/third_party/starboard/rdk/shared/system.gyp:ocdm',
        ],
      }],
      ...
      ['"<(rdk_video_resolution)"=="1080p"', {
        'common_defines': [
          'VIDEO_RESOLUTION_1080P',
        ],
      }],
      ['"<(rdk_video_resolution)"=="2160p"', {
        'common_defines': [
          'VIDEO_RESOLUTION_2160P',
        ],
      }],
      ['"<(rdk_video_resolution)"=="720p"', {
        'common_defines': [
